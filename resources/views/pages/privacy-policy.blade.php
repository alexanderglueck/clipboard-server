@extends('layouts.app', [
    ...
    'description' => 'The privacy policy of the Universal Clipboard App.'
])
...
@section('content')
    ...
    <ul class="">
        ...
        <li>
            <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Universal Clipboard App.
        </li>
        <li>
        ...
        <li>
            <strong>Website</strong> refers to Universal Clipboard App, accessible from <a href="https://clipboard.gdev.at" rel="external nofollow noopener" target="_blank">https://clipboard.gdev.at</a>
        </li>
        <li>
    ...
    <h2>Contact Us</h2>
    <p>If you have any questions about this Privacy Policy, You can contact us by email: support@gdev.at</p>
@endsection
